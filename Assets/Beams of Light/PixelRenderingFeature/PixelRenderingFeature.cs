...
public class PixelRenderingFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        // Only enqueue normals + outlines for the pixel camera (renders to our specific RT)
        if (cam.targetTexture == _settings.rt)
            renderer.EnqueuePass(_normalsPass);
        
        // Only enqueue the upscale blit for the MainCamera (presents to screen)
